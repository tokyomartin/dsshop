...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"DSSHOP电商商城","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 10:
/*!**************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/utils/index.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.createUniqueString = createUniqueString;exports.diffArary = diffArary;exports.uniqueArr = uniqueArr;exports.objectURLToBlob = objectURLToBlob;exports.addDate = addDate;exports.authMsg = authMsg;exports.getLogin = getLogin;exports.getPlatform = getPlatform;var _config = _interopRequireDefault(__webpack_require__(/*! ./config.js */ 11));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * @returns {string}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               */
...
function diffArary(arr1, arr2) {
  arr1 = uniqueArr(arr1);
  arr2 = uniqueArr(arr2);
  return arr1.concat(arr2).filter(function (arg) {return !(arr1.includes(arg) && arr2.includes(arg));});
}
...
function getLogin() {
  ...
  uni.login({
    success: function success(res) {
      if (res.code) {
        uni.request({
          url: _config.default.BaseURL + 'miniLogin',
          data: {
            code: res.code,
          ...
          header: {
            ...
            'apply-secret': _config.default.secret,
...
/***/ 102:
/*!*****************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/goodIndent.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _network = _interopRequireDefault(__webpack_require__(/*! ../utils/network.js */ 30));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  getList: function getList(data, success, fail) {
    _network.default.setGetMessage('goodIndent', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  detail: function detail(id, success, fail) {
    _network.default.setGetMessage('goodIndent/detail/' + id, {}, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  create: function create(data, success, fail) {
    _network.default.setPostMessage('goodIndent', data, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  synchronizationInventory: function synchronizationInventory(data, success, fail) {
    _network.default.setPostMessage('goodIndent/synchronizationInventory', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  addShoppingCart: function addShoppingCart(data, success, fail) {
    _network.default.setPostMessage('goodIndent/addShoppingCart', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  pay: function pay(id, success, fail) {
    _network.default.setGetMessage('goodIndent/pay/' + id, {}, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  receipt: function receipt(id, success, fail) {
    _network.default.setPostMessage('goodIndent/receipt/' + id, {}, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  cancel: function cancel(id, success, fail) {
    _network.default.setPostMessage('goodIndent/cancel/' + id, {}, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  destroy: function destroy(id, success, fail) {
    _network.default.setPostMessage('goodIndent/destroy/' + id, {}, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  quantity: function quantity(success, fail) {
    _network.default.setGetMessage('goodIndent/quantity', {}, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 11:
/*!***************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/utils/config.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var configURL = {};
var NODE_ENV = 'test'; // prod:生产环境 | test:测试环境  
var INTERFACE = '/api/v1/app/';
var applyDsshopNodeEnv = ''; //保存当前环境

if (true) {
  //本地环境(小程序调试时请勾选不检验合法域名，且手机无法调试，需要调试，请修改此地址为外网地址)
  var domainName = 'http://dsshop.test';
  configURL = {
...
} else { var _domainName2, _domainName; }
...
configURL;exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 143:
/*!*******************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/notification.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{
  getList: function getList(data, success, fail) {
    _network.default.setGetMessage('notification', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  unread: function unread(data, success, fail) {
    _network.default.setGetMessage('notification/unread', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  destroy: function destroy(id, success, fail) {
    _network.default.setPostMessage('notification/destroy/' + id, {}, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 17:
/*!***************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/utils/filter.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var filter = {
  '1000': function _(val) {//字符串转货币, 保留二位小数
    return parseFloat(val).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,');
  },
  'smallImage': function smallImage(img, size) {//显示小图片
...
/***/ 18:
/*!********************************************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/node_modules/vue-clipboard2/vue-clipboard.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var Clipboard = __webpack_require__(/*! clipboard/dist/clipboard.min.js */ 19); // FIXME: workaround for browserify
...
/***/ 182:
/*!***************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/shipping.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{
  getList: function getList(data, success, fail) {
    _network.default.setGetMessage('shipping', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  create: function create(data, success, fail) {
    _network.default.setPostMessage('shipping', data, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  edit: function edit(data, success, fail) {
    _network.default.setPostMessage('shipping/' + data.id, data, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  destroy: function destroy(id, success, fail) {
    _network.default.setPostMessage('shipping/destroy/' + id, {}, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  defaultGet: function defaultGet(data, success, fail) {
    _network.default.setPostMessage('shipping/default/get', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  defaultSet: function defaultSet(data, success, fail) {
    _network.default.setPostMessage('shipping/default/set', data, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 19:
/*!********************************************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/node_modules/clipboard/dist/clipboard.min.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 215:
/*!***************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/moneyLog.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{
  getList: function getList(data, success, fail) {
    _network.default.setGetMessage('moneyLog', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  detail: function detail(id, data, success, fail) {
    _network.default.setGetMessage('moneyLog/' + id, data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 232:
/*!**********************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/pay.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _network = _interopRequireDefault(__webpack_require__(/*! ../utils/network.js */ 30));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  unifiedPayment: function unifiedPayment(data, success, fail) {
    _network.default.setPostMessage('unifiedPayment', data, '支付中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  balancePay: function balancePay(data, success, fail) {
    _network.default.setPostMessage('balancePay', data, '支付中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 272:
/*!*****************************************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/components/gaoyia-parse/libs/html2json.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _wxDiscode = _interopRequireDefault(__webpack_require__(/*! ./wxDiscode */ 273));
var _htmlparser = _interopRequireDefault(__webpack_require__(/*! ./htmlparser */ 274));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
...
/***/ 273:
/*!*****************************************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/components/gaoyia-parse/libs/wxDiscode.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 274:
/*!******************************************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/components/gaoyia-parse/libs/htmlparser.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 29:
/*!***********************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/good.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{
  getList: function getList(data, success, fail) {
    _network.default.setGetMessage('good', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  detail: function detail(id, data, success, fail) {
    _network.default.setGetMessage('good/' + id, data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  goodCategory: function goodCategory(data, success, fail) {
    _network.default.setGetMessage('goodCategory', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 30:
/*!****************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/utils/network.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _utils = __webpack_require__(/*! utils */ 10);
var _config = _interopRequireDefault(__webpack_require__(/*! ./config.js */ 11));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
// success:成功的回调函数
// fail：失败的回调
function requestLoading(url, method, params, header, message, _success, _fail) {
  // console.log(params)
  ...
  var applytoken = uni.getStorageSync('dsshopApplytoken');
  ...
  uni.request({
    ...
    success: function success(res) {
      ...
      if (res.statusCode == 200) {
        if (res.data.result === 'ok') {
          _success(res.data.message);
        } else {
          _fail({ message: res.data });
        }
        ...
        _fail({ message: '服务器异常，请重新尝试' });
      } else if (res.statusCode == 302) {

        (0, _utils.getLogin)();

        _fail({ message: '登录超时，请重新登录' });
      } else if (res.statusCode == 401) {
        _fail({ message: res.data.message });
      } else {
        _fail({ message: '服务器异常，请重新尝试' });
      }
...
/***/ 31:
/*!*************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/banner.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{
  getList: function getList(data, success, fail) {
    _network.default.setGetMessage('banner', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 4:
/*!**********************************************!*\
  !*** D:/www/dsshop/client/Dsshop/pages.json ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 40:
/*!***************************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/components/sku/sku2param.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.param2Data = param2Data;var _utils = __webpack_require__(/*! ../../utils */ 10);


var _utils2 = __webpack_require__(/*! ./utils */ 41);function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
function param2Data(product_skus_data) {
  ...
  var productSkus = product_skus_data.map(function (item) {
    var skusObj = _objectSpread(_objectSpread({},
    item), {}, {
      product_sku_id: item.id,
      skus: item.product_sku.map(function (sku, index) {
        // const spec_random_id = createUniqueString() + '_id'
        // const option_random_id = createUniqueString() + '_id'
        var spec_random_id = 'sku' + (0, _utils.createUniqueString)();
        var option_random_id = 'sku' + (0, _utils.createUniqueString)();
        ...
        var sepc_id = spec_id_dict[sku.key];
        var option_id = option_id_dict[sku.value];

        specificationObj[sku.key] = {
          value: sku.key,
          id: sepc_id,
          leaf: _objectSpread(_objectSpread({},
          specificationObj[sku.key] ? specificationObj[sku.key].leaf : {}), {}, _defineProperty({},
          sku.value, {
            value: sku.value,
            id: option_id,
            selected: false,
    ...
    skusObj), {}, {
      ids: (0, _utils2.creatIds)(skusObj.skus),
      data: (0, _utils2.combInArray)(skusObj.skus) });

  });

  var specification = objectValues(specificationObj).map(function (item) {return _objectSpread(_objectSpread({},
    item), {}, {
...
/***/ 41:
/*!***********************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/components/sku/utils.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getLevels = getLevels;exports.flatten = flatten;exports.isEqual = isEqual;exports.combInArray = combInArray;exports.getCombFlags = getCombFlags;exports.creatIds = void 0;function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function _objectWithoutProperties(source, excluded) {if (source == null) return {};var target = _objectWithoutPropertiesLoose(source, excluded);var key, i;if (Object.getOwnPropertySymbols) {var sourceSymbolKeys = Object.getOwnPropertySymbols(source);for (i = 0; i < sourceSymbolKeys.length; i++) {key = sourceSymbolKeys[i];if (excluded.indexOf(key) >= 0) continue;if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue;target[key] = source[key];}}return target;}function _objectWithoutPropertiesLoose(source, excluded) {if (source == null) return {};var target = {};var sourceKeys = Object.keys(source);var key, i;for (i = 0; i < sourceKeys.length; i++) {key = sourceKeys[i];if (excluded.indexOf(key) >= 0) continue;target[key] = source[key];}return target;} // skus: [{"k_id":1,"k":"颜色","v_id":11,"v":"红色"},{"k_id":2,"k":"尺寸","v_id":22,"v":"小"}],
// output：1-11_2-22
var creatIds = function creatIds(skus) {return skus.reduce(function (total, prev, index) {return "".concat(total).concat(prev.k_id, "-").concat(prev.v_id).concat(index === skus.length - 1 ? '' : '_');}, '');};

// 计算每个sku后面有多少项
exports.creatIds = creatIds;function getLevels(tree) {
  var level = [];
...
/**
   ...
   */
function flatten(tree) {var stocks = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];var options = arguments.length > 2 ? arguments[2] : undefined;var _ref =
  options || {},_ref$optionValue = _ref.optionValue,optionValue = _ref$optionValue === void 0 ? 'id' : _ref$optionValue,_ref$optionText = _ref.optionText,optionText = _ref$optionText === void 0 ? 'value' : _ref$optionText;
  var result = [];
  var skuLen = 0;
  var stockMap = {}; // 记录已存在的stock的数据
  var level = getLevels(tree);
  if (tree.length === 0) return result;
  tree.forEach(function (sku) {var
    leaf = sku.leaf;
    if (!leaf || leaf.length === 0) return true;
    skuLen = (skuLen || 1) * leaf.length;
  });
  // 根据已有的stocks生成一个map
  stocks.forEach(function (stock) {var
    skus = stock.skus,attr = _objectWithoutProperties(stock, ["skus"]);
    stockMap[skus.map(function (item) {return "".concat(item.k_id, "_").concat(item.v_id);}).join('|')] = attr;
  });var _loop = function _loop(
  i) {
    var skus = [];
    var mapKey = [];
    tree.forEach(function (sku, column) {var
      leaf = sku.leaf;
      var item = {};
      if (!leaf || leaf.length === 0) return true;
      if (leaf.length > 1) {
      ...
      mapKey.push("".concat(sku[optionValue], "_").concat(item[optionValue]));
      skus.push({
    ...
    stockMap[mapKey.join('|')] || {},data = Object.assign({}, _ref2);
    // 从map中找出存在的sku并保留其值
    result.push(_objectSpread(_objectSpread({}, data), {}, { skus: skus }));};for (var i = 0; i < skuLen; i++) {_loop(i);
  }
  return result;
}
...
/**
   ...
   */
function isEqual(prevSKU, nextSKU, options) {var _ref3 =
  options || {},_ref3$optionValue = _ref3.optionValue,optionValue = _ref3$optionValue === void 0 ? 'id' : _ref3$optionValue;
  return (
    nextSKU.length === prevSKU.length &&
    nextSKU.every(function (_ref4, index) {var _ref4$leaf = _ref4.leaf,leaf = _ref4$leaf === void 0 ? [] : _ref4$leaf;
      var prevLeaf = prevSKU[index].leaf || [];
      return (
        prevSKU[index][optionValue] === nextSKU[index][optionValue] &&
        leaf.length === prevLeaf.length &&
        leaf.map(function (item) {return item[optionValue];}).join(',') ===
        prevLeaf.map(function (item) {return item[optionValue];}).join(','));
...
/***/ 42:
/*!*************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/browse.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{
  getList: function getList(data, success, fail) {
    _network.default.setGetMessage('browse', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  create: function create(data, success, fail) {
    _network.default.setPostMessage('browse', data, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 43:
/*!**************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/collect.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{
  getList: function getList(data, success, fail) {
    _network.default.setGetMessage('collect', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  create: function create(data, success, fail) {
    _network.default.setPostMessage('collect', data, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  detail: function detail(id, success, fail) {
    _network.default.setGetMessage('collect/' + id, {}, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  destroy: function destroy(id, success, fail) {
    _network.default.setPostMessage('collect/destroy/' + id, {}, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 441:
/*!*************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/coupon.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{
  getList: function getList(data, success, fail) {
    _network.default.setGetMessage('coupon', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  getUserList: function getUserList(data, success, fail) {
    _network.default.setGetMessage('coupon/user', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  count: function count(success, fail) {
    _network.default.setGetMessage('coupon/user/count', {}, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  create: function create(data, success, fail) {
    _network.default.setPostMessage('coupon', data, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 442:
/*!**************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/comment.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{
  detail: function detail(id, success, fail) {
    _network.default.setGetMessage('comment/detail/' + id, {}, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  good: function good(data, success, fail) {
    _network.default.setGetMessage('comment/good', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  create: function create(id, data, success, fail) {
    _network.default.setPostMessage('comment/' + id, data, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 449:
/*!*************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/column.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{
  getList: function getList(data, success, fail) {
    _network.default.setGetMessage('column', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  detail: function detail(id, data, success, fail) {
    _network.default.setGetMessage('column/' + id, data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  pv: function pv(id, data, success, fail) {
    _network.default.setPost('column/pv/' + id, data, function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 458:
/*!**************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/article.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _network = _interopRequireDefault(__webpack_require__(/*! ../utils/network.js */ 30));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  getList: function getList(id, data, success, fail) {
    _network.default.setGetMessage('article/column/' + id, data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  detail: function detail(id, data, success, fail) {
    _network.default.setGetMessage('article/' + id, data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  pv: function pv(id, data, success, fail) {
    _network.default.setPost('article/pv/' + id, data, function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 499:
/*!********************************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/components/QS-SharePoster/app.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
      ...
      if (backgroundImage) {
        ...
        switch (type) {//根据type获取背景图, 一般要改成request获取
          case 1:
            ...
            break;
          default:
            image = '/static/temp/ad-splash.jpg';
            break;}
...
/***/ 5:
/*!**************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/store/index.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 500:
/*!*******************************************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/components/QS-SharePoster/QS-SharePoster.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 26));var _app2 = _interopRequireDefault(__webpack_require__(/*! ./app.js */ 499));
var _QRCodeAlg = _interopRequireDefault(__webpack_require__(/*! ./QRCodeAlg.js */ 501));
var _imageTools = __webpack_require__(/*! ./image-tools.js */ 502);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _toConsumableArray(arr) {return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread();}function _nonIterableSpread() {throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(o);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _iterableToArray(iter) {if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter);}function _arrayWithoutHoles(arr) {if (Array.isArray(arr)) return _arrayLikeToArray(arr);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}
...
function returnPromise(obj) {var
  ...
  return new Promise( /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(rs, rj) {var bgObj, params, i, hasAllInfoCallback, _i, drawArrayItem, newData, drawArray_copy, _i2, item, _newData, item_idKey, poster;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.prev = 0;
              ...
              imagesArray) {_context2.next = 21;break;}
              if (typeof imagesArray == 'function')
              imagesArray = imagesArray(params);
              _app2.default.showLoading('正在生成需绘制图片的临时路径');_context2.next = 19;return (
                setImage(imagesArray));case 19:imagesArray = _context2.sent;
              _app2.default.hideLoading();case 21:
              ...
              _i = 0;case 44:if (!(_i < drawArray.length)) {_context2.next = 76;break;}
              ...
              'custom' ? 64 : _context2.t0 ===

              'fillrect' ? 65 : _context2.t0 ===

              'strokeRect' ? 66 : _context2.t0 ===

              'roundStrokeRect' ? 67 : _context2.t0 ===

              'roundFillRect' ? 68 : 69;break;case 52:_context2.next = 54;return setImage(drawArrayItem);case 54:newData = _context2.sent;return _context2.abrupt("break", 71);case 56:newData = setText(Context, drawArrayItem);return _context2.abrupt("break", 71);case 58:if (!drawArrayItem.image) {_context2.next = 63;break;}_context2.next = 61;return _app2.default.downloadFile_PromiseFc(drawArrayItem.image);case 61:_context2.t1 = _context2.sent;newData = { image: _context2.t1 };case 63:return _context2.abrupt("break", 71);case 64:return _context2.abrupt("break", 71);case 65:return _context2.abrupt("break", 71);case 66:return _context2.abrupt("break", 71);case 67:return _context2.abrupt("break", 71);case 68:return _context2.abrupt("break", 71);case 69:
              ...
              };case 73:_i++;_context2.next = 44;break;case 76:if (!
              ...
              }case 90:_i2++;_context2.next = 80;break;case 93:if (!(
              ...
              setCanvasWH && typeof setCanvasWH == 'function')) {_context2.next = 96;break;}_context2.next = 96;return (
                ...
                drawShareImage({
                  ...
                  drawDelayTime: drawDelayTime }));case 98:poster = _context2.sent;

              _app2.default.hideLoading();
              rs({
                bgObj: bgObj,
                poster: poster,
                type: type });_context2.next = 106;break;case 103:_context2.prev = 103;_context2.t2 = _context2["catch"](0);


              //TODO handle the exception
              rj(_context2.t2);case 106:case "end":return _context2.stop();}}}, _callee2, null, [[0, 103]]);}));return function (_x3, _x4) {return _ref2.apply(this, arguments);};}());
...
function countTextLength(Context, obj) {var
...
function drawCircleImage(Context, obj) {var
...
function getShreUserPosterBackground(objs) {//检查背景图是否存在于本地， 若存在直接返回， 否则调用getShreUserPosterBackgroundFc方法
  ...
  return new Promise( /*#__PURE__*/function () {var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee5(resolve, reject) {var savedFilePath;return _regenerator.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:_context5.prev = 0;
              ...
              _app2.default.hideLoading();
              resolve(savedFilePath);_context5.next = 14;break;case 9:_context5.prev = 9;_context5.t0 = _context5["catch"](0);

              _app2.default.hideLoading();
              _app2.default.showToast('获取分享用户背景图失败:' + JSON.stringify(_context5.t0));
              reject(_context5.t0);case 14:case "end":return _context5.stop();}}}, _callee5, null, [[0, 9]]);}));return function (_x9, _x10) {return _ref5.apply(this, arguments);};}());
...
function getShreUserPosterBackgroundFc(objs, upimage) {//下载并保存背景图方法
  ...
  return new Promise( /*#__PURE__*/function () {var _ref6 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee6(resolve, reject) {var image, savedFilePath, imageObj, returnObj;return _regenerator.default.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:_context6.prev = 0;
              ...
              backgroundImage) {_context6.next = 6;break;}_context6.t0 = backgroundImage;_context6.next = 9;break;case 6:_context6.next = 8;return _app2.default.getPosterUrl(objs);case 8:_context6.t0 = _context6.sent;case 9:image = _context6.t0;_context6.next = 12;return (
                base64ToPathFn(image));case 12:image = _context6.sent;_context6.next = 15;return (
                _app2.default.downLoadAndSaveFile_PromiseFc(image));case 15:savedFilePath = _context6.sent;if (!
              savedFilePath) {_context6.next = 26;break;}_context6.next = 19;return (
                _app2.default.getImageInfo_PromiseFc(savedFilePath));case 19:imageObj = _context6.sent;
              returnObj = {
                path: savedFilePath,
              ...
              _app2.default.hideLoading();
              resolve(_objectSpread({}, returnObj));_context6.next = 28;break;case 26:


              _app2.default.hideLoading();
              reject('not find savedFilePath');case 28:_context6.next = 33;break;case 30:_context6.prev = 30;_context6.t1 = _context6["catch"](0);


              //TODO handle the exception
              reject(_context6.t1);case 33:case "end":return _context6.stop();}}}, _callee6, null, [[0, 30]]);}));return function (_x11, _x12) {return _ref6.apply(this, arguments);};}());
...
/***/ 501:
/*!**************************************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/components/QS-SharePoster/QRCodeAlg.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 502:
/*!****************************************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/components/QS-SharePoster/image-tools.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 511:
/*!**********************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/vip.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{
  getList: function getList(data, success, fail) {
    _network.default.setGetMessage('vip', data, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 52:
/*!************************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/login.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _network = _interopRequireDefault(__webpack_require__(/*! ../utils/network.js */ 30));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  login: function login(data, success, fail) {
    _network.default.setPostMessage('login', data, '登录中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  register: function register(data, success, fail) {
    _network.default.setPostMessage('register', data, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  verifyEmail: function verifyEmail(data, success, fail) {
    _network.default.setPostMessage('verifyEmail', data, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  findPassword: function findPassword(data, success, fail) {
    _network.default.setPostMessage('findPassword', data, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  authorization: function authorization(data, success, fail) {
    _network.default.setPost('authorization', data, function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  cellphoneCode: function cellphoneCode(data, success, fail) {
    _network.default.setPost('cellphoneCode', data, function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  emailCode: function emailCode(data, success, fail) {
    _network.default.setPostMessage('emailCode', data, '处理中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  logout: function logout(data, success, fail) {
    _network.default.setPostMessage('logout', {}, '退出中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
...
/***/ 61:
/*!***********************************************!*\
  !*** D:/www/dsshop/client/Dsshop/api/user.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _network = _interopRequireDefault(__webpack_require__(/*! ../utils/network.js */ 30));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  detail: function detail(success, fail) {
    _network.default.setGetMessage('user', {}, '加载中', function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  edit: function edit(data, success, fail) {
    _network.default.setPost('user', data, function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  notification: function notification(data, success, fail) {
    _network.default.setPost('user/notification', data, function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,
  ...
  cancel: function cancel(data, success, fail) {
    _network.default.setPost('cancel', data, function (res) {
      success(res);
    }, function (res) {
      uni.showToast({
        title: res.message,

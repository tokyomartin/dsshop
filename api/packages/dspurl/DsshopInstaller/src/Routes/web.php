...
Route::group(['prefix' => 'install', 'as' => 'DsshopInstaller::', 'namespace' => 'Dspurl\DsshopInstaller\Controllers', 'middleware' => ['web', 'install']], function () {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update', 'as' => 'DsshopUpdater::', 'namespace' => 'Dspurl\DsshopInstaller\Controllers', 'middleware' => 'web'], function () {

        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item {{ isActive('DsshopInstaller::final') }}">
                        <i class="step__icon fa fa-server" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('DsshopInstaller::environment')}} {{ isActive('DsshopInstaller::environmentWizard')}} {{ isActive('DsshopInstaller::environmentClassic')}}">
                        @if(Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('DsshopInstaller::environment') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('DsshopInstaller::permissions') }}">
                        @if(Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('DsshopInstaller::permissions') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('DsshopInstaller::requirements') }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('DsshopInstaller::requirements') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('DsshopInstaller::welcome') }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('DsshopInstaller::welcome') }}">

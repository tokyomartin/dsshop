...
*/
//安装
Route::get('server', 'InstallController@server');  //服务器要求
Route::get('jurisdiction', 'InstallController@jurisdiction');  //权限检测
Route::post('configuration', 'InstallController@configuration');  //项目配置
Route::get('dispose', 'InstallController@dispose');  //项目安装
